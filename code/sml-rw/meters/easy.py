...
class Easy(Meter):
    ...
    def enterPin(self, pinArray: [int]):
    ...
    def toggle(self, pinArray: [int], menuItem: str):
        self.enterPin(pinArray)
        self._pause()
        menuLocation = 0
        menuTotal = 11
        if menuItem == "info":
    ...
    def clear(self, pinArray: [int], menuItem: str):
        self.enterPin(pinArray)
        self._pause()
        menuLocation = 0
        menuTotal = 11
    ...
    def show(self, pinArray: [int], menuItem: str):
        self.enterPin(pinArray)
        self._pause()
        menuLocation = 0
        menuTotal = 11
